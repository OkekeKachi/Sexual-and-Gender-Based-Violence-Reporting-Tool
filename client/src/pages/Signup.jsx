...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Basic validation
    if (!form.firstName || !form.lastName || !form.email || !form.password || !form.confirm_password || !form.phone) {
    ...
    <>
      ...
      <style>{`
        ...
        @keyframes float-slow {
         ...
         .input-row-appear:nth-child(5) { animation-delay: 0.44s; }
         .input-row-appear:nth-child(6) { animation-delay: 0.52s; }
          ...
          <div className="grid w-full max-w-6xl items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="relative hidden lg:block panel-appear">
              ...
              <div className="relative z-10">
                ...
                >
                  Your Voice <span style={{ color: "#2A9D8F" }}>Matters</span>
                </h1>
                <p className="mt-5 max-w-md text-[15px] leading-relaxed text-slate-600">
                  Safely report incidents, upload evidence, track your cases, and receive confidential support through SafeSpeak.
                </p>
                {/* feature bullets */}
                  ...
                  {[
                    {
                      ...
                      title: "Secure & encrypted reporting",
                      desc: "Your data is protected with end-to-end encryption.",
                    },
                    {
                      icon: <EyeOff size={16} />,
                      title: "Anonymous reporting available",
                      desc: "Share your story without revealing your identity if you choose.",
                    },
                    {
                      icon: <FileText size={16} />,
                      title: "Case tracking with Case ID",
                      desc: "Monitor the progress of your reports securely.",
                    },
                    {
                      icon: <MessageSquare size={16} />,
                      title: "Secure messaging with caseworkers",
                      desc: "Communicate privately with your assigned support team.",
                    },
                  ].map((f, i) => (
                  ...
                  <>
                    ...
                    <div className="mb-7">
                      ...
                      <p className="mt-1.5 text-[14px] text-slate-500">
                        Join SafeSpeak to securely report incidents, track your cases, communicate with assigned caseworkers, and access support services.
                      </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} noValidate className="space-y-5">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="form-appear input-row-appear space-y-1.5">
                          <label htmlFor="firstName" className="block text-[13px] font-semibold tracking-wide text-slate-700">
                            First Name
                          </label>
                          <div className="group relative flex items-center rounded-xl border border-slate-200 bg-white transition-all duration-200 hover:border-slate-300 focus-within:border-teal-500 focus-within:ring-4 focus-within:ring-teal-100">
                            <User size={17} className="absolute left-4 text-slate-400 transition-colors duration-200 group-focus-within:text-teal-600" aria-hidden="true" />
                            <input
                              id="firstName"
                              name="firstName"
                              type="text"
                        ...
                        <div className="form-appear input-row-appear space-y-1.5">
                          <label htmlFor="lastName" className="block text-[13px] font-semibold tracking-wide text-slate-700">
                            Last Name
                          </label>
                          <div className="group relative flex items-center rounded-xl border border-slate-200 bg-white transition-all duration-200 hover:border-slate-300 focus-within:border-teal-500 focus-within:ring-4 focus-within:ring-teal-100">
                            <User size={17} className="absolute left-4 text-slate-400 transition-colors duration-200 group-focus-within:text-teal-600" aria-hidden="true" />
                      ...
                      {/* Email */}
                      <div className="form-appear input-row-appear space-y-1.5">
                        <label htmlFor="email" className="block text-[13px] font-semibold tracking-wide text-slate-700">
                          Email Address
                        </label>
                        <div className="group relative flex items-center rounded-xl border border-slate-200 bg-white transition-all duration-200 hover:border-slate-300 focus-within:border-teal-500 focus-within:ring-4 focus-within:ring-teal-100">
                          <Mail size={17} className="absolute left-4 text-slate-400 transition-colors duration-200 group-focus-within:text-teal-600" aria-hidden="true" />
                          <input
                            id="email"
                            name="email"
                            type="email"
                      ...
                      {/* Password */}
                      <div className="form-appear input-row-appear space-y-1.5">
                        <label htmlFor="password" className="block text-[13px] font-semibold tracking-wide text-slate-700">
                          Password
                        </label>
                        <div className="group relative flex items-center rounded-xl border border-slate-200 bg-white transition-all duration-200 hover:border-slate-300 focus-within:border-teal-500 focus-within:ring-4 focus-within:ring-teal-100">
                          <Lock size={17} className="absolute left-4 text-slate-400 transition-colors duration-200 group-focus-within:text-teal-600" aria-hidden="true" />
                          <input
                            id="password"
                            name="password"
                      ...
                      {/* Confirm Password */}
                      <div className="form-appear input-row-appear space-y-1.5">
                        <label htmlFor="confirm_password" className="block text-[13px] font-semibold tracking-wide text-slate-700">
                          Confirm Password
                        </label>
                        <div className="group relative flex items-center rounded-xl border border-slate-200 bg-white transition-all duration-200 hover:border-slate-300 focus-within:border-teal-500 focus-within:ring-4 focus-within:ring-teal-100">
                          <Lock size={17} className="absolute left-4 text-slate-400 transition-colors duration-200 group-focus-within:text-teal-600" aria-hidden="true" />
                    ...
                    {/* Security note */}
                    <div className="flex items-center justify-center gap-2 rounded-xl border border-slate-100 bg-slate-50/70 px-4 py-3">
